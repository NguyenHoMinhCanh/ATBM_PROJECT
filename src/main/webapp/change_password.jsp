            ...
            <div class="col-lg-3">
                <div class="acc-side">
                    ...
                    <div class="acc-menu">
                        ...
                        <a class="active" href="${ctx}/change-password"><i class="bi bi-shield-lock"></i> Bảo mật & chữ ký điện tử</a>
            ...
            <div class="col-lg-9">
                <div class="d-flex align-items-start justify-content-between mb-3">
                    <div>
                        ...
                        <div class="text-muted">Quản lý mật khẩu và thông tin chữ ký số RSA của bạn</div>
                    </div>
